...
def main():
    ...
    persons = [{"name": x["name"], "wiki_id": x["wikidata_id"], "image_url": x["image_url"]}
    ...
    # cache for search box
    parties = [{"name": x["party_label"], "wiki_id": x["wiki_id"], "image_url": x["party_logo"]}
