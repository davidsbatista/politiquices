...
neo4j:
	...
	docker run -dit -p 127.0.0.1:7474:7474 -p 127.0.0.1:7687:7687 -v $${HOME}/politiquices/politiquices/webapp/neo4j_import/:/var/lib/neo4j/import -e NEO4J_AUTH=neo4j/s3cr3t -e NEO4J_dbms.connector.bolt.address=127.0.0.1::7687 neo4j
	sleep 40s;
